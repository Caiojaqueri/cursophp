...
<body>
    ...
    <main>
        ...
        <form action="<?=$_SEVER['PHP_SELF']?>" method="get">
    ...
    <section>
        <?php 
            $ma = ($valor1 + $valor2) / 2;
            $mp = ($valor1 * $peso1 + $valor2 * $peso2)/($peso1 + $peso1);
        ?>
        ...
        <ul>
            ...
            <li>A <strong>Média Atitimética Ponderada </strong>entre os valores é igual a <?=number_format($mp, 2, ",", ".")?>.</li>
